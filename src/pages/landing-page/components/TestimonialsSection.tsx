...
const TestimonialsSection = ({
  ...
  const testimonials: TestimonialData[] = [
    // Worker Testimonials
    {
      ...
      audience: "worker",
      content: `WE Community changed my college life completely! I earn ₹12,000+ every month doing data entry and content writing tasks. The verification process made me feel safe, and instant UPI payments mean I never have to wait for my money. Perfect for students like me who need flexible income.`,
      rating: 5,
    ...
    },
    {
      ...
      avatar:
        "https://img.rocket.new/generatedImages/rocket_gen_img_1ff5b3609-1762274360519.png",
    ...
    },
    {
      ...
      audience: "worker",
      content: `As a homemaker, WE Community gave me the perfect opportunity to earn from home. I do graphic design tasks during my free time and earn ₹8,000+ monthly. The flexible timing and instant payments make it ideal for managing household responsibilities.`,
      rating: 5,
    ...
    // Business Testimonials
    {
      ...
      audience: "business",
      content: `WE Community solved our biggest problem - finding reliable talent quickly. We've hired 50+ verified students for various projects and saved 60% on our operational costs. The quality of work and professionalism of workers is outstanding. Game-changer for small businesses!`,
      rating: 5,
      savings: "60% cost reduction",
      avatar:
        "https://img.rocket.new/generatedImages/rocket_gen_img_1f50b0990-1762274155673.png",
    ...
    },
    {
      ...
      audience: "business",
      content: `The verification system on WE Community is incredible. Every worker we've hired has been professional and skilled. We've completed 100+ projects with zero payment disputes thanks to the escrow system. It's our go-to platform for finding quality talent.`,
      rating: 5,
      savings: "40% time saved",
      avatar:
        "https://img.rocket.new/generatedImages/rocket_gen_img_1cef3e415-1762274502183.png",
    ...
    // Investor Testimonials
    {
      ...
      audience: "investor",
      content: `WE Community represents the future of India's gig economy. The community verification model and focus on trust sets them apart. With projected goals of ₹50L+ paid to workers and 10,000+ completed tasks in Year 1, the potential is impressive. Excited to be part of this journey.`,
      rating: 5,
      returns: "20x+ projected returns",
      avatar:
        "https://img.rocket.new/generatedImages/rocket_gen_img_191605a11-1762274216267.png",
  ...
  const relevantTestimonials = testimonials.filter(
    (testimonial) => testimonial.audience === selectedAudience
  );
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            {selectedAudience === "worker" &&
              "Hear from students and professionals who are earning flexible income through our platform."}
            {selectedAudience === "business" &&
              "Discover how businesses are finding quality talent and reducing costs with our verified workers."}
            {selectedAudience === "investor" &&
              "Learn why investors are excited about our growth potential and market opportunity."}
          </motion.p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-6">
                  ...
                  <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl px-6 py-4 text-center">
                    <div className="text-2xl font-heading-bold text-primary mb-1">
                      {currentTestimonialData.earnings ||
                        currentTestimonialData.savings ||
                        currentTestimonialData.returns}
                    </div>
          ...
          <div className="flex justify-center items-center space-x-4 mt-8">
            ...
            <button
              onClick={() => {
                setCurrentTestimonial(
                  currentTestimonial === relevantTestimonials.length - 1
                    ? 0
                    : currentTestimonial + 1
                );
                setIsAutoPlaying(false);
        ...
        <div className="mt-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto mb-4">
            ...
            >
              <div className="text-3xl font-heading-bold text-primary mb-2">
                4.8/5
              </div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-3xl font-heading-bold text-success mb-2">
                10K+
              </div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-3xl font-heading-bold text-secondary mb-2">
                ₹50L+
              </div>
